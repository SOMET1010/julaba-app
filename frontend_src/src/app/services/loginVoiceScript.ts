...
export const SCRIPT_TATA: PhraseScript[] = [
  ...
  { id: 'AUTH_11', categorie: 'CONNEXION', moment: 'Numéro incomplet', texteFr: "Il manque encore des chiffres. Continue.", texteDyu: "Dɔ b'a la fɔlɔ. Fɔ ka t'a la." },
  ...
  { id: 'AUTH_16', categorie: 'CONNEXION', moment: 'Micro indisponible', texteFr: "Le micro ne marche pas là. Tape ton numéro ici.", texteDyu: "Mikoro tɛ baara kɛra sisan. I ka nimɔrɔ sɛbɛn yan." },
  ...
  { id: 'AUTH_19', categorie: 'CONNEXION', moment: 'Code en chiffres', texteFr: "Bon, mets les quatre chiffres de ton code.", texteDyu: "Bon, i ka kɔdi nimɔrɔ naani bila yan." },
  ...
  { id: 'AUTH_21', categorie: 'CONNEXION', moment: 'Passage aux images', texteFr: "Voilà les images à la place des chiffres. Ton code n'a pas changé.", texteDyu: "Ja le bɛ yan sisan nimɔrɔw nɔrɔ la. I ka kɔdi ma yɛlɛma." },
  { id: 'AUTH_22', categorie: 'CONNEXION', moment: 'Retour aux chiffres', texteFr: "Et voilà les chiffres. Mets ton code comme avant.", texteDyu: "Nimɔrɔw nana tugun. I ka kɔdi bila i n'a fɔ kɔrɔlen." },
  ...
  { id: 'AUTH_24', categorie: 'CONNEXION', moment: 'Effacement', texteFr: "C'est effacé.", texteDyu: "A josila." },
  ...
  { id: 'AUTH_26', categorie: 'CONNEXION', moment: 'Reconnaissance échouée', texteFr: "Ça n'a pas marché. On fait avec ton code.", texteDyu: "A ma taga. An b'a kɛ n'i ka kɔdi ye." },
  ...
  { id: 'AUTH_30', categorie: 'CONNEXION', moment: 'Trop de tentatives', texteFr: "Tu as essayé trop de fois. Attends un peu avant de reprendre.", texteDyu: "I y'a ɲini siɲɛ caaman kojugu. Makɔnni dɔɔnin sanni k'a daminɛ tugun." },
  ...
  { id: 'AUTH_33', categorie: 'CONNEXION', moment: 'Nouvelle tentative automatique', texteFr: "Ça prend un peu de temps. Patiente, je réessaie.", texteDyu: "A bɛ waati dɔɔnin ta. Sabali dɔɔnin, n'bɛ kɔsegi a la." },
  ...
  { id: 'AUTH_35', categorie: 'CONNEXION', moment: 'Choix enregistré', texteFr: "D'accord, on va faire comme ça.", texteDyu: "Ayiwa, an b'a kɛ ten." },
  { id: 'AUTH_36', categorie: 'CONNEXION', moment: 'Choix conservé', texteFr: "D'accord, on continue comme avant.", texteDyu: "Ayiwa, an b'a to ten i n'a fɔ kɔrɔlen." },
