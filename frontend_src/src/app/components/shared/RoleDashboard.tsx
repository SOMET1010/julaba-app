...
interface RoleDashboardProps {
  ...
  hideTataLouImage?: boolean; // Nouvelle prop pour cacher l'image Tantie Nanti Lou
...
export function RoleDashboard({
  ...
  // Ref Tantie Nanti Lou (image bounce)
      ...
      {!hideTataLouImage && (
        ...
        >
          <div className="flex items-stretch gap-2">
            {/* Image Tantie Nanti Lou à gauche */}
            <motion.div
