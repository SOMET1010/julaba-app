...
const DESCRIPTIONS = [
  'Tantie Nanti Lou reste silencieuse. Tu navigues seul, sans assistance vocale.',
  'Tantie Nanti Lou te parle uniquement pour les alertes importantes et les confirmations.',
  "Tantie Nanti Lou t'accompagne sur toutes les actions — ventes, navigation et conseils.",
];
...
export function VoiceLevelSelector({ value, onChange, color }: VoiceLevelSelectorProps) {
  return (
    <div style={{ padding: '16px 20px' }}>
      <p style={{ fontWeight: 700, color: '#111827', marginBottom: 4 }}>Voix de Tantie Nanti Lou</p>
      <p style={{ fontSize: 12, color: '#9ca3af', marginBottom: 12 }}>Choisir quand Tantie Nanti Lou te parle</p>
