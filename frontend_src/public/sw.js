...
// Liste de tous les assets de build à PRÉ-CHARGER (injectée au build par vite.config).
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    // Pré-cache de l'application : tolérant aux échecs (un asset manquant ne bloque pas
