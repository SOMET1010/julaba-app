...
| **P0** | Invariante d'argent à brancher en **continu** (cron/déploiement) contre la base réelle | `scripts/verifier-invariante-argent.mjs` | Un garde-fou ne protège que s'il tourne aussi sur la prod, pas seulement en CI. |
