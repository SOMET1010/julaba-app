...
| ~~P1~~ ✅ | ~~**Accueil télécharge TOUT le journal**~~ **RÉSOLU** | `GET /caisse/resume` + accueil allégé | L'accueil consomme désormais un **résumé serveur** (~128 o, poids constant) au lieu du journal complet (2,4 Mo à 5 000 mvts). Le détail n'est chargé qu'à l'ouverture de l'historique. Vérifié : 2 470 661 o → 128 o. |
