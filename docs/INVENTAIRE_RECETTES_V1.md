...
- admin_general : tout sauf les modules superOnly (utilisateurs._, parametres._).
...
- Valeurs de production des variables d'environnement et secrets (BPAY*\*, ELEVENLABS*_, OPENAI*API_KEY, ONECI*_ hors valeurs sandbox par defaut, VAPID*\*, ANSUT*\*) : non presentes dans le code, donc comportement runtime reel des integrations non observable sans l'environnement deploye.
