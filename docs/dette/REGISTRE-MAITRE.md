...
| **VOIX-06** | **P1 fonctionnel voix** | **OUVERT** | *Ouverte à la révision 30 (lot B2), introduite PAR B2, reproduite par lecture.* **L'état « vente gardée sur le téléphone » n'a aucun canal non visuel garanti.** Il n'a ni vibration (aucune, par consigne de Patrick), ni région annoncée (`role="status"` / `aria-live` volontairement absents de l'écran de fin) : il ne reste que le TTS. Si la voix est coupée (`guidageVocal()` à faux), muette, ou indisponible sur l'appareil, l'information ne passe plus que par une icône et du texte — devant une marchande qui ne lit pas. C'est frontalement contraire à la doctrine : « aucune information importante uniquement en texte ». **À dire honnêtement : sur la base, le succès mensonger VIBRAIT** — B2 supprime ce canal tactile en même temps qu'il supprime le mensonge, et l'état d'attente naît donc plus pauvre que l'état faux qu'il remplace | **Ce n'est pas un défaut de mise en œuvre, c'est un arbitrage non tranché.** `vibrerSucces()` ne devait surtout pas être réemployé sous un autre nom, et un motif haptique inédit se confond avec le succès tant qu'il n'a pas été appris — dans la poche, au bruit du marché. L'option la plus conservatrice a donc été retenue : **aucune vibration**, l'absence de la double impulsion faisant elle-même signal. Deux décisions appartiennent à Patrick, et à lui seul : (1) un motif haptique propre à l'attente ; (2) rendre l'écran de fin annoncé, sachant que Tata parle déjà les deux issues et qu'un lecteur d'écran redirait par-dessus | **Condition de clôture :** l'état « gardée » est perceptible par au moins un canal non visuel qui ne dépend pas du TTS, OU Patrick tranche explicitement que le TTS suffit pour cet état et la ligne se ferme sur sa décision, écrite. Prouvé par un garde-fou dans `verify` qui lit le code de l'écran de caisse. Dettes voisines : OFF-01 (fermée), OFF-02, VOIX-04, VOIX-05 |
