...
**Révision 19 — VOIX-01 FERMÉE au contre-audit n°3 (`e45feb6`) : la relecture financière est dite ET affichée, même chaîne, même snapshot ; le chemin d'argent est intact après les lots F et F2. Deux lignes UI ouvertes, un arbitrage visuel à trancher.**
...
**Compte courant : 30 FERMÉ · 5 HORS PÉRIMÈTRE JUSTIFIÉ · 50 OUVERT** *(recompté ligne à ligne à la révision 19 : 85 lignes ; VOIX-01 passe à FERMÉ ; UI-02 et UI-03 ouvertes)*.
