...
**Compte courant : 38 FERMÉ · 5 HORS PÉRIMÈTRE JUSTIFIÉ · 51 OUVERT** *(recompté ligne à ligne à la révision 22 : 94 lignes ; VOICE-01 passe à FERMÉ ; VOIX-04, VOIX-05, GARDE-02, SEC-08b et TEST-05 ajoutées OUVERTES ; aucune ligne du lot B modifiée de statut — non fusionné) ; **révision 23 : recompté, inchangé — lot C non fusionné, aucune ligne ajoutée ni modifiée de statut**)*.
